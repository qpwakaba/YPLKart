package main.java.com.github.erozabesu.YPLKart.Utils;
...
public enum Particle {
	...
	public static void sendToPlayer(String effect, Player player, Location location, float offsetX, float offsetY, float offsetZ, float speed, int count) {
		try {
	...
	public static void sendToLocation(String effect, Location location, float offsetX, float offsetY, float offsetZ, float speed, int count) {
		try {
			Object packet = createPacket(effect, location, offsetX, offsetY, offsetZ, speed, count);
	...
	public static void sendToLocationWide(String effect, Location location, float offsetX, float offsetY, float offsetZ, float speed, int count, double radius) {
