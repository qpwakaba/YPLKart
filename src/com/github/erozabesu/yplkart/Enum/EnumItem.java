...
public enum EnumItem {
    ...
    ItemBoxToolTier2(Permission.op_cmd_itemboxtool, Material.INK_SACK, (byte) 0, 0, 1, 64, "高級アイテムボックスツール",
            "1段階豪華なアイテムをゲットできるアイテムボックスを設置します。"),
    FakeItemBoxTool(Permission.op_cmd_itemboxtool, Material.INK_SACK, (byte) 0, 0, 1, 64, "にせアイテムボックスツール",
            "にせアイテムボックスを設置します。当たっても復活します。"),
    Menu(null, Material.GOLD_INGOT, (byte) 0, 0, 1, 64, "メニューを開きます", ""),

    Star(Permission.use_star, Material.NETHER_STAR, (byte) 0, Settings.StarTier, 1, Settings.StarMaxStackSize,
            "スーパースター", "一定時間無敵になり、ぶつかったプレイヤーがひどい目に遭います。さらにスピードも速くなります。"),
    StarMultiple(Permission.use_star, Material.NETHER_STAR, (byte) 0, Settings.StarMultipleTier,
            Settings.StarMultipleDropAmount, Settings.StarMaxStackSize, "スーパースター",
            "一定時間無敵になり、ぶつかったプレイヤーがひどい目に遭います。さらにスピードも速くなります。"),
    Mushroom(Permission.use_mushroom, Material.INK_SACK, (byte) 1, Settings.MushroomTier, 1,
            Settings.MushroomMaxStackSize, "ダッシュキノコ", "一定時間プレイヤーのスピードが上がります。"),
    MushroomMultiple(Permission.use_mushroom, Material.INK_SACK, (byte) 1, Settings.MushroomMultipleTier,
            Settings.MushroomMultipleDropAmount, Settings.MushroomMaxStackSize, "ダッシュキノコ", "一定時間プレイヤーのスピードが上がります。"),
    PowerfullMushroom(Permission.use_powerfullmushroom, Material.INK_SACK, (byte) 2, Settings.PowerfullMushroomTier, 1,
            Settings.PowerfullMushroomMaxStackSize, "パワフルダッシュキノコ", "一定時間プレイヤーのスピードが上がります。"),
    PowerfullMushroomMultiple(Permission.use_powerfullmushroom, Material.INK_SACK, (byte) 2,
            Settings.PowerfullMushroomMultipleTier, Settings.PowerfullMushroomMultipleDropAmount,
            Settings.PowerfullMushroomMaxStackSize, "パワフルダッシュキノコ", "一定時間プレイヤーのスピードが上がります。"),
    Turtle(Permission.use_turtle, Material.INK_SACK, (byte) 3, Settings.TurtleTier, 1, Settings.TurtleMaxStackSize,
            "ミドリこうら", "投げると直進し、当たったプレイヤーを爆破します。"),
    TurtleMultiple(Permission.use_turtle, Material.INK_SACK, (byte) 3, Settings.TurtleMultipleTier,
            Settings.TurtleMultipleDropAmount, Settings.TurtleMaxStackSize, "ミドリこうら", "投げると直進し、当たったプレイヤーを爆破します。"),
    RedTurtle(Permission.use_redturtle, Material.INK_SACK, (byte) 4, Settings.RedTurtleTier, 1,
            Settings.RedTurtleMaxStackSize, "アカこうら", "投げると前方のプレイヤーを追いかけ、当たったプレイヤーを爆破します。"),
    RedTurtleMultiple(Permission.use_redturtle, Material.INK_SACK, (byte) 4, Settings.RedTurtleMultipleTier,
            Settings.RedTurtleMultipleDropAmount, Settings.RedTurtleMaxStackSize, "アカこうら",
            "投げると前方のプレイヤーを追いかけ、当たったプレイヤーを爆破します。"),
    ThornedTurtle(Permission.use_thornedturtle, Material.INK_SACK, (byte) 5, Settings.ThornedTurtleTier, 1,
            Settings.ThornedTurtleMaxStackSize, "トゲゾーこうら",
            "投げると先頭のプレイヤーを追いかけ、当たったプレイヤーを爆破します。先頭のプレイヤーに追いつくまで、他のプレイヤーに当たっても進み続けます。"),
    ThornedTurtleMultiple(Permission.use_thornedturtle, Material.INK_SACK, (byte) 5,
            Settings.ThornedTurtleMultipleTier, Settings.ThornedTurtleMultipleDropAmount,
            Settings.ThornedTurtleMaxStackSize, "トゲゾーこうら",
            "投げると先頭のプレイヤーを追いかけ、当たったプレイヤーを爆破します。先頭のプレイヤーに追いつくまで、他のプレイヤーに当たっても進み続けます。"),
    Banana(Permission.use_banana, Material.INK_SACK, (byte) 6, Settings.BananaTier, 1, Settings.BananaMaxStackSize,
            "バナナ", "コースに設置でき、接触したプレイヤーを減速させます。"),
    BananaMultiple(Permission.use_banana, Material.INK_SACK, (byte) 6, Settings.BananaMultipleTier,
            Settings.BananaMultipleDropAmount, Settings.BananaMaxStackSize, "バナナ", "コースに設置でき、接触したプレイヤーを減速させます。"),
    FakeItembox(Permission.use_fakeitembox, Material.INK_SACK, (byte) 7, Settings.FakeItemBoxTier, 1,
            Settings.FakeItemBoxMaxStackSize, "にせアイテムボックス", "アイテムボックスにそっくりですが、触れると減速します。"),
    FakeItemboxMultiple(Permission.use_fakeitembox, Material.INK_SACK, (byte) 7, Settings.FakeItemBoxMultipleTier,
            Settings.FakeItemBoxMultipleDropAmount, Settings.FakeItemBoxMaxStackSize, "にせアイテムボックス",
            "アイテムボックスにそっくりですが、触れると減速します。"),
    Thunder(Permission.use_thunder, Material.INK_SACK, (byte) 8, Settings.ThunderTier, 1, Settings.ThunderMaxStackSize,
            "サンダー", "ライバルのプレイヤーが一定時間遅くなります。"),
    ThunderMultiple(Permission.use_thunder, Material.INK_SACK, (byte) 8, Settings.ThunderMultipleTier,
            Settings.ThunderMultipleDropAmount, Settings.ThunderMaxStackSize, "サンダー", "ライバルのプレイヤーが一定時間遅くなります。"),
    Teresa(Permission.use_teresa, Material.INK_SACK, (byte) 9, Settings.TeresaTier, 1, Settings.TeresaMaxStackSize,
            "テレサ", "一定時間透明になり、ライバルの攻撃を受けなくなります。さらにランダムでライバルからアイテムを奪います。"),
    TeresaMultiple(Permission.use_teresa, Material.INK_SACK, (byte) 9, Settings.TeresaMultipleTier,
            Settings.TeresaMultipleDropAmount, Settings.TeresaMaxStackSize, "テレサ",
            "一定時間透明になり、ライバルの攻撃を受けなくなります。さらにランダムでライバルからアイテムを奪います。"),
    Gesso(Permission.use_gesso, Material.INK_SACK, (byte) 10, Settings.GessoTier, 1, Settings.GessoMaxStackSize,
            "ゲッソー", "自分より上位のプレイヤーの画面に墨を吐いて画面を見難くします。"),
    GessoMultiple(Permission.use_gesso, Material.INK_SACK, (byte) 10, Settings.GessoMultipleTier,
            Settings.GessoMultipleDropAmount, Settings.GessoMaxStackSize, "ゲッソー", "自分より上位のプレイヤーの画面に墨を吐いて画面を見難くします。"),
    Killer(Permission.use_killer, Material.INK_SACK, (byte) 11, Settings.KillerTier, 1, Settings.KillerMaxStackSize,
            "キラー", ""),
    KillerMultiple(Permission.use_killer, Material.INK_SACK, (byte) 11, Settings.KillerMultipleTier,
            Settings.KillerMultipleDropAmount, Settings.KillerMaxStackSize, "キラー", "");
