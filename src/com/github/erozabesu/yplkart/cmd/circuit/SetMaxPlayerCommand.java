...
/**
 * /ka circuit setmaxplayerコマンドクラス。
 * @author King
 * @author erozabesu
 */
public class SetMaxPlayerCommand extends Command {
    public SetMaxPlayerCommand() {
        super("setmaxplayer");
    }
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        ...
        CircuitConfig.setMaxPlayer(sender, circuitName, maxValue);
        return true;
    }
}
