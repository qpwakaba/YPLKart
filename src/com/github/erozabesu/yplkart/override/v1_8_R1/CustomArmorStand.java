...
public class CustomArmorStand extends EntityArmorStand {
    ...
    public CustomArmorStand(World world, Kart kart, KartType kartType, Location location) {
        ...
        setArms(true);
        setInvisible(true);
        //setMarker(false);//XXX: CraftBukkit Unstable 1.8.1以前ではMarker機能が存在しないため、このメソッドは不要
        setBasePlate(true);
     ...
     */
    @Override
    public void s_()//XXX: CraftBukkit Unstable
    {
    ...
    public boolean isClientSide(Entity entity) {
        return entity.getWorld().isStatic;//XXX: CraftBukkit Unstable
    }
    ...
    public boolean isNoclip(Entity entity) {
        return entity.T;//XXX: CraftBukkit Unstable
    }
    ...
    //XXX: CraftBukkit Unstable 1.8.1以前ではMarker機能が存在しないため、このメソッドは不要
    ...
    public float getForwardMotionInput(EntityHuman human) {
        return human.aY;//XXX: CraftBukkit Unstable
    }
    ...
    public float getSideMotionInput(EntityHuman human) {
        return human.aX;//XXX: CraftBukkit Unstable
    }
    ...
    public float getMotionInputStrength(EntityHuman human) {
        return human.bH();//XXX: CraftBukkit Unstable
    }
    ...
    public void setNoclip(Entity entity, boolean isNoclip) {
        entity.T = isNoclip;//XXX: CraftBukkit Unstable
    }
    ...
    public void setEntitySize(float width, float length) {
        a(width, length);//XXX: CraftBukkit Unstable
    }
